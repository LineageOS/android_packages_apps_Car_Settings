...
public class UserDetailsHeaderPreferenceControllerTest {
    ...
    private UserDetailsHeaderPreferenceController mPreferenceController;
    ...
    public void setUp() {
        ...
        mPreferenceController = new UserDetailsHeaderPreferenceController(mContext,
    ...
    @Test
    public void onCreate_userNotSetup_setsSummary() {
        UserInfo userInfo = new UserInfo(/* id= */ 10, TEST_USERNAME, /* flags= */ 0);
        mPreferenceController.setUserInfo(userInfo);
        PreferenceControllerTestUtil.assignPreference(mPreferenceController, mPreference);
        mPreferenceController.onCreate(mLifecycleOwner);
    ...
    @Test
    public void onCreate_userSetup_noSummary() {
    ...
    @Test
    public void onCreate_isAdmin_notCurrentUser() {
    ...
    @Test
    public void onCreate_isAdmin_currentUser() {
        UserInfo userInfo = new UserInfo(/* id= */ 10, TEST_USERNAME,
                FLAG_INITIALIZED | FLAG_ADMIN);
