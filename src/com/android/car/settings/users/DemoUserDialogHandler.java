...
/**
 * Consolidates demo user dialog logic into one handler so we can have
 * consistent logic across various parts of the Settings app.
 */
public class DemoUserDialogHandler {
    ...
    public DemoUserDialogHandler(Context context, FragmentController fragmentController) {
        mContext = context;
    ...
    public void showExitRetailDialog() {
        ConfirmationDialogFragment dialogFragment =
                UsersDialogProvider.getConfirmExitRetailModeDialogFragment(mContext,
