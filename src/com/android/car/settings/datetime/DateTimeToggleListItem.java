...
/**
 * A ListItem that displays and sets system auto date/time.
 */
class DateTimeToggleListItem extends TextListItem
        implements DatetimeSettingsFragment.ListRefreshObserver {
    private Context mContext;
    private final String mSettingString;

    DateTimeToggleListItem(Context context, String title, String desc,
