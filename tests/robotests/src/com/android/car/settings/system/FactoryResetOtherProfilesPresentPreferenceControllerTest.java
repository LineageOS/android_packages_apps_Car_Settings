...
public class FactoryResetOtherProfilesPresentPreferenceControllerTest {
    ...
    public void setUp() {
        ...
        PreferenceControllerTestHelper<FactoryResetOtherProfilesPresentPreferenceController>
                controllerHelper = new PreferenceControllerTestHelper<>(context,
                FactoryResetOtherProfilesPresentPreferenceController.class, mPreference);
