...
class AgentAppFunctionAccessPreferenceControllerTest {
    private lateinit var preferenceController: AgentAppFunctionAccessPreferenceController
    ...
    fun setUp() {
        ...
        preferenceController = AgentAppFunctionAccessPreferenceController(
    ...
    @Test
    fun isValidPackage_returnsTrue_whenPackageIsValidAgent() {
        whenever(mockAppFunctionManager.validAgents).thenReturn(listOf(testPackageName))
        assertThat(preferenceController.isValidPackage(testPackageName)).isTrue()
    }

    @Test
    fun isValidPackage_returnsFalse_whenPackageIsNotValidAgent() {
        whenever(mockAppFunctionManager.validAgents).thenReturn(emptyList())
    ...
    fun isValidPackage_returnsFalse_whenManagerIsNull() {
        ...
        val controllerWithNullManager = AgentAppFunctionAccessPreferenceController(
            context,
            "preferenceKey",
