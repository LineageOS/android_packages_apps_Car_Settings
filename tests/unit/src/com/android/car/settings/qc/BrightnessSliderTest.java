...
public class BrightnessSliderTest {
    ...
    public void setUp() {
        ...
        mBrightnessSlider = new BrightnessSlider(mContext);
    ...
    public void getQCItem_titleAndIconSet() {
        ...
        assertThat(row.getTitle()).isEqualTo(mContext.getString(R.string.display_brightness));
    ...
    private QCRow getBrightnessRow() {
